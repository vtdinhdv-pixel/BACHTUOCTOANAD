...
import { X, Info, Shield, BarChart2, Trash2 } from "lucide-react";
...
export default function PlusMenu({ isOpen, onClose, stats, onClearHistory }: PlusMenuProps) {
...
function MenuButton({ icon, label, onClick, variant = 'default' }: { icon: any, label: string, onClick: () => void, variant?: 'default' | 'danger' }) {
  return (
    <button 
      onClick={onClick}
